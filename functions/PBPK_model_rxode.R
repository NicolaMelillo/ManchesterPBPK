...
PBPK.ACAT <- RxODE({
  ...
  # kidneys
  clear_kid       <- CLr * fup * (kidneys/organ_v_kidneys)/(part_coeff_kidneys)
  ...
  ### liver equations
  outflow_liv  <- organ_bf_liver * (liver/organ_v_liver)/(part_coeff_liver/BP)
